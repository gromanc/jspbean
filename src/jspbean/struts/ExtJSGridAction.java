...
@Action(value = "grid-filter", results = {
  @Result(type = "json")
})
public class ExtJSGridAction extends ActionSupport {

  private static final long serialVersionUID = 5078264277068533593L;
  private static final Log log              = LogFactory.getLog(ExtJSGridAction.class);
  ...
  public String execute()
  {
    ...
    data = userDAO.findByCriteria(criteria, from, rows);
